...
# model
MODEL_NAME = 'TripletNet' # EfficientNetB7, TripletNet
IMAGE_SIZE = 224

# hyperparameter
EPOCHS = 1000
LEARNING_RATE = 0.0003
BATCH_SIZE = 4 # number of images in a single batch

# root path
ROOT_PATH = 'C:/Users/USER/Desktop/capstone_revised'
...
if MODEL_NAME == 'TripletNet':
    ...
    PRETRAINED_CHECKPOINT_PATH_1 = os.path.join(RESULT_PATH, f'EfficientNetB7_{DATA}_{IMAGE_SIZE}_{EPOCHS}_{LEARNING_RATE}_{8}', 'checkpoint')
